...
export function cm6Theme(): ReturnType<typeof EditorView.theme> {
    return EditorView.theme({
        '&': {
            ...
            height: '100%',
            fontSize: '15px',
            '--cm-md-fence-inset': '12px',
            '--cm-md-fence-chrome-inset': '6px',
            '--cm-md-fence-external-gap': '32px',
        },
        '.cm-scroller': {
        ...
        '.cm-md-fenced-code-line-first': {
            ...
            paddingTop: 'var(--cm-md-fence-inset)',
        },
        '.cm-md-fenced-code-line-last': {
            borderBottom: '1px solid var(--color-border-subtle)',
            borderRadius: '0 0 var(--surface-radius) var(--surface-radius)',
            paddingBottom: 'var(--cm-md-fence-inset)',
        },
        '.cm-md-fenced-code-external-gap': {
            display: 'block',
            height: 'var(--cm-md-fence-external-gap)',
            pointerEvents: 'none',
        },
        '.cm-md-fenced-code-line-first.cm-md-fenced-code-line-last': {
            borderRadius: 'var(--surface-radius)',
        },
        '.cm-md-fence-chrome-host': {
            position: 'relative',
            height: '0',
            overflow: 'visible',
            zIndex: '2',
        ...
        '.cm-md-fence-chrome': {
            ...
            left: '0',
            right: '0',
            marginTop: 'var(--cm-md-fence-chrome-inset)',
            height: '20px',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'flex-end',
            gap: '6px',
            padding: '0 var(--cm-md-fence-chrome-inset)',
            boxSizing: 'border-box',
        },
        '.cm-md-fence-chrome-overlay': {
            top: '8px',
            right: '8px',
            left: 'auto',
            width: 'auto',
        ...
        '.cm-md-fence-chrome-overlay .cm-md-mermaid-zoom-btn': {
            border: 'none',
        ...
        '.cm-md-fence-chrome-overlay:hover .cm-md-mermaid-zoom-btn': {
            opacity: '1',
        },
        '.cm-md-fence-chrome-overlay .cm-md-mermaid-zoom-btn:hover': {
            opacity: '1',
            background: 'color-mix(in srgb, var(--color-text-primary) 8%, transparent)',
        },
        '.cm-md-fence-chrome-overlay .cm-md-mermaid-zoom-btn:disabled': {
            opacity: '0.2',
        },
        '.cm-md-fence-chrome-overlay .cm-md-mermaid-mode-select': {
            opacity: '0.65',
            background: 'transparent',
            borderColor: 'color-mix(in srgb, var(--color-border-default) 60%, transparent)',
        },
        '.cm-md-fence-chrome-overlay:hover .cm-md-mermaid-mode-select': {
            opacity: '1',
        },
        '.cm-md-fence-chrome-overlay .cm-md-mermaid-zoom-pct': {
            opacity: '0.65',
        },
        '.cm-md-fence-chrome-overlay:hover .cm-md-mermaid-zoom-pct': {
            opacity: '1',
        },
        '.cm-md-fence-actions': {
            display: 'flex',
        ...
        '.cm-md-fence-chrome:hover .cm-md-fence-copy-btn': {
            opacity: '1',
        },
        '.cm-md-fence-copy-btn:hover': {
            opacity: '1',
            background: 'color-mix(in srgb, var(--color-text-primary) 8%, transparent)',
            color: 'var(--color-text-primary)',
        },
        ...
        '.cm-md-mermaid-zoom-controls': {
            display: 'flex',
            alignItems: 'center',
            gap: '2px',
        },
        '.cm-md-mermaid-zoom-btn': {
            display: 'inline-flex',
            alignItems: 'center',
            justifyContent: 'center',
            width: '20px',
        ...
        '.cm-md-mermaid-zoom-btn:disabled': {
            opacity: '0.4',
            cursor: 'default',
        },
        '.cm-md-mermaid-zoom-pct': {
            fontSize: '11px',
            fontFamily: 'var(--font-mono)',
            fontWeight: 'var(--font-mono-weight)',
            color: 'var(--color-text-secondary)',
